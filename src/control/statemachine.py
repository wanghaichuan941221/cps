...
def state0(angles, setpoints, endeffector_to_box, endeffector_to_droppoint, tx, ty):
    print("state0 start")
...
def state1(angles, setpoints, endeffector_to_box, endeffector_to_droppoint, tx, ty):
...
def state2(angles, setpoints, endeffector_to_box, endeffector_to_droppoint, tx, ty):
...
def state3(angles, setpoints, endeffector_to_box, endeffector_to_droppoint, tx, ty):
...
def state4(angles, setpoints, endeffector_to_box, endeffector_to_droppoint, tx, ty):
...
def state5(angles, setpoints, endeffector_to_box, endeffector_to_droppoint, tx, ty):
...
def state6(angles, setpoints, endeffector_to_box, endeffector_to_droppoint, tx, ty):
    print("state6 control motor1 for setpoint")
    usb_direction =  usbarm.get_usb_direction(setpoints, angles)
    usbarm.ctrl(usb_direction[0])
    return None

def state7(angles, setpoints, endeffector_to_box, endeffector_to_droppoint, tx, ty):
...
def state8(angles, setpoints, endeffector_to_box, endeffector_to_droppoint, tx, ty):
    global state_counter
...
def state9(angles, setpoints, endeffector_to_box, endeffector_to_droppoint, tx, ty):
...
def state10(angles, setpoints, endeffector_to_box, endeffector_to_droppoint, tx, ty):
    print("state10 control motor1 for setpoint")
    usb_direction =  usbarm.get_usb_direction(setpoints, angles)
    usbarm.ctrl(usb_direction[0])
    return None

def state11(angles, setpoints, endeffector_to_box, endeffector_to_droppoint, tx, ty):
...
def state12(angles, setpoints, endeffector_to_box, endeffector_to_droppoint, tx, ty):
    global state_counter
...
def state13(angles, setpoints, endeffector_to_box, endeffector_to_droppoint, tx, ty):
...
def state14(angles, setpoints, endeffector_to_box, endeffector_to_droppoint, tx, ty):
    print("state14 control motor1 for droppoint")
    usb_direction =  usbarm.get_usb_direction(setpoints_droppoint, angles)
    usbarm.ctrl(usb_direction[0])
    return None

def state15(angles, setpoints, endeffector_to_box, endeffector_to_droppoint, tx, ty):
...
def state16(angles, setpoints, endeffector_to_box, endeffector_to_droppoint, tx, ty):
    global state_counter
