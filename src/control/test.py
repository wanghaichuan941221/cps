...
print("theta1,setpoint1",get_theta1_setpoint1(pixal_cordinates_top))
print("theta2,theta3,theta4",get_theta234_side1(pixal_cordinates_side1))
print("distance",get_distance_to_object(pixalcordinates_top,pixalcordinates_side1,calibration_distance_in_cm,height_object_in_cm))