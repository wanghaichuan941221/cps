    ...
    def run(self):
        if self.is_top_view:
            ...
            while self.running:
                ...
                cv2.imwrite('~/Desktop/Images/img' + str(imgNr), img)
                cv2.imwrite('~/Desktop/Images/mask_red' + str(imgNr), mask_red)
                cv2.imwrite('~/Desktop/Images/mask_yellow' + str(imgNr), mask_yellow)
                if len(circles) == 3:
                    circles.sort()
